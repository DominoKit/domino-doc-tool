...
import org.dominokit.doctool.DominoDocsDoclet;
  ...
  public void testDocs() throws IOException {
    ...
    String[] args =
        new String[] {
          ...
          DominoDocsDoclet.DUI_DOCS_OUT_DIRE,
          "target/apidocs/",
          DominoDocsDoclet.DUI_DOCS_ROOT_URL,
    ...
    DocumentationTool.DocumentationTask task =
        systemDocumentationTool.getTask(
            null, null, null, DominoDocsDoclet.class, Arrays.asList(args), null);
    task.call();
  }
}
